...
public class AlleleFreqDriver extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        int res= ToolRunner.run(new Configuration(),new AlleleFreqDriver(),args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(AlleleFreqMapper.class);
        job.setReducerClass(AlleleFreqReducer.class);
