...
public class StripesUserItemDriver extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        int res= ToolRunner.run(new Configuration(),new StripesUserItemDriver(),args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(StripesUserItemMapper.class);
        job.setReducerClass(StripesUserItemReducer.class);
