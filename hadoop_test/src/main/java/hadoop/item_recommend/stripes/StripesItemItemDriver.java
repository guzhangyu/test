...
public class StripesItemItemDriver extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        int res= ToolRunner.run(new Configuration(),new StripesItemItemDriver(),args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(StripesItemItemMapper.class);
        job.setReducerClass(StripesItemItemReducer.class);
