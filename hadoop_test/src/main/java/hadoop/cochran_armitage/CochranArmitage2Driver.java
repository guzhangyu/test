...
public class CochranArmitage2Driver extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        int res= ToolRunner.run(new Configuration(),new CochranArmitage2Driver(),args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(CochranArmitage2Mapper.class);
        job.setReducerClass(CochranArmitage2Reducer.class);
